...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{During the intensive Data Science program, my job was to master the art of taking large data sets, analyze them using different types of models and algorithms to gain insights, and predict trends.} % Description(s) of tasks/responsibilities
